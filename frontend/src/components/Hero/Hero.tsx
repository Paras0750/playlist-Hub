    ...
    <div className="mx-5 w-[96%] overflow-hidden rounded-4xl bg-transparent shadow-xl">
      <div className="relative flex h-[50vh] flex-col justify-center rounded-4xl bg-[url('/Hero.png')] bg-cover bg-center">
        ...
        <button
          ...
          className="text-accentText font-subHeadingText absolute top-6 left-6 z-10 rounded-full bg-white/90 px-4 py-1 text-sm font-medium tracking-wider backdrop-blur-md"
        >
          Trending Now
        </button>
        ...
        <div className="absolute z-10 flex flex-col justify-center gap-6 px-10 selection:text-white/45">
          ...
          <div>
            <h1 className="flex flex-col text-5xl font-bold">
              ...
              <span className="font-headingText bg-gradient-to-r from-accentText to-[#fbad6cd8] bg-clip-text text-transparent">
                sonic sanctuary
              </span>
            </h1>
          ...
          <div className="relative z-10 flex items-center gap-4">
            ...
            <button
              ...
              className="
                ...
                px-6 py-3 font-light text-white
